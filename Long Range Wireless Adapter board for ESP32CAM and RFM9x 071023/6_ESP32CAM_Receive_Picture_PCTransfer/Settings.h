...
#define RXD2 -1               //RX pin for monitor port, not used 
#define TXD2 33               //TX pin for monitor port

#define LORA_DEVICE DEVICE_SX1278               //this is the device we are using

#define Monitorport Serial2                     //progress and monitor message go to Serial2 on pin 33
...
const uint32_t ACKdelaystartendmS = 25;         //ms delay before ack sent at array start write and end write
...
const uint32_t ReceiveTimeoutmS = 10000;        //mS waiting for array transfer before timeout
