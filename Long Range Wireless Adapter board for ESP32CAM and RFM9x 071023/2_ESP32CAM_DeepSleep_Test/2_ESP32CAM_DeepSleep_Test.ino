...
/*******************************************************************************************************
  ...
  found the redled will flash continuously. Sleep current with SD card inserted and camera connected is
  circa 3mA.
...
//pinouts for ESP32CAM_Long_Range_Wireless_Adapter PCB dated 290922
