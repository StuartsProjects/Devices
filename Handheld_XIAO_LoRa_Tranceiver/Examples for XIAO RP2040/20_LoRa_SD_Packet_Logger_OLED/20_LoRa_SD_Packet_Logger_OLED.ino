...
/*******************************************************************************************************
  ...
  Program Operation - The program for the Seeeduino XIAO RP2040 listens for incoming packets using the
  LoRa settings in the 'Settings.h' file. The pins to access the lora device need to be defined in the
...
void loop()
{
  ...
  digitalWrite(RED1, LOW);                       //something has happened
