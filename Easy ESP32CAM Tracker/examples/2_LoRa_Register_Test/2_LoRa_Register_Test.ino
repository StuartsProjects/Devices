...
/*******************************************************************************************************
  Program Operation - This test program is for the SX127X LoRa devices. This program is stand alone, it
  is not necessary to install the SX12XX-LoRa library to use it.  The program is intended for use on the
  Easy ESP32CAM board.
  ...
  2_LoRa_Register_Test for ESP32CAM Starting
  LoRa Device found
  Device version 0x12
...
void setup()
{
  ...
  Serial.println();
  Serial.println();
  Serial.println(F("2_LoRa_Register_Test for ESP32CAM Starting"));
