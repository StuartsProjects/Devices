...
/*******************************************************************************************************
  ...
  battery voltage on pin 14 has been assembled correctly. The value defined as 'ADMultiplier'
  in settings.h is used to adjust (calibrate) the value read from the 100K\47K resistor divider and convert
  into the battery mV.
