...
const uint8_t NSS = 5;                          //select pin on LoRa device
const uint8_t NRESET 27                         //reset pin on LoRa device
const uint8_t DIO0 35                           //DIO0 pin on LoRa device, used for sensing RX and TX done 
const uint8_t CS = 17;                          //select pin for Arducam
