...
const int8_t StartTXpower = 20;      //Start TX power for link test
const int8_t EndTXpower = -9;        //End TX power for link test
...
const uint16_t packet_delay = 250;   //mS delay between packets
const uint16_t cycle_delay = 1250;   //mS delay between cycles
