...
void loop()
{
  ...
  Serial.flush();
  led_Flash(10, 500);                          //60 1 second LED flashes to indicate program awake
}
...
void setup()
{
  ...
  led_Flash(10, 500);                                                //10 one second LED flashes to indicate program start

  Serial.begin(115200);
  Serial.println();
  Serial.println(F("12_Wakeup_On_External_Interrupt"));
