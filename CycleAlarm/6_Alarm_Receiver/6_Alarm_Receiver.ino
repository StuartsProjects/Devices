/*******************************************************************************************************
  Programs for Arduino - Copyright of the author Stuart Robinson - 19/09/22
...
/*******************************************************************************************************
  ...
  The program was tested on an ATmega328P processor with 2 x AAA batteries as the power source.
  ...
  The transmitter, see program '4_Alarm_Transmitter', sends two types of packet, and alarm packet which will
  ...
  Use with matching program 5_Alarm_Transmitter.
...
#define LED1 8                                  //on board LED
#define LED2 A2                                 //external LED
#define BUZZ A3                                 //external buzzer 
...
#define ADMultiplier 8.62                       //adjustment to convert AD value read into mV of battery voltage 
...
void ActionAlarm()
{
  ...
  digitalWrite(LED1, LOW);                  //on board LED off
...
{
  //relies on internal reference and 100K & 12K resistor divider
  uint16_t temp;
  uint16_t volts = 0;
  uint8_t index;
