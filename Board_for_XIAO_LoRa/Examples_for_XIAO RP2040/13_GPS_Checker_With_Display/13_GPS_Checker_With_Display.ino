...
/*******************************************************************************************************
  ...
  Program Operation -  This program is a portable GPS checker for the Seeduino XIAO RP2040 with a display.
...
void setup()
{
  ...
  Serial.println(F("13_GPS_Checker_With_Display Starting"));
  Serial.println();
